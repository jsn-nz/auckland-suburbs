...
const Table = (() => {
  ...
  const COLS = [
    ...
    { key: "median_rent", label: "Rent /wk (census)", get: s => s.median_rent, fmt: Palette.fmtDollar },
    { key: "bond_rent", label: "Rent /wk (bonds)", get: s => s.bond_rent, fmt: Palette.fmtDollar },
    ...
    { key: "consents_12m", label: "Consents 12m", get: s => s.consents_12m, fmt: Palette.fmtInt },
    { key: "flood_pct", label: "Flood plain %", get: s => s.flood_pct, fmt: Palette.fmtPct },
    { key: "n_schools", label: "Schools", get: s => s.n_schools, fmt: v => v == null ? "0" : String(v) },
